        ...
        if not res_account : 
            ...
            while True :
                ...
                try :
                    ...
                    continue
                input_NY = input('* 입금하실 금액이 '+str(input_deposit_amount)+'원이 맞습니까?(Y/N) : ')
                if input_NY == 'N' :
                    continue
            ...
            try :
                if res_account[0][1] != int(input_accountpw) : 
                    ...
                    #거래기록 기재
                    sql_inset_trans = 'INSERT INTO TRANSACTION (trans_type, trans_amount, trans_balance, trans_account) VALUE (\'입금\',' + str(input_deposit_amount)+','+str(res_updated_account_balance[0][0])+',\''+input_accountid+'\')'
